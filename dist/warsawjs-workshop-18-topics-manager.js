...
var Helpers = function () {
    ...
    _createClass(Helpers, [{
        ...
        key: "test",
        value: function test() {
            //static is private method and won't be available in export
...
/*jshint esversion: 6 */
var helpers = new _helper2.default();

_hellojs2.default.init({
    github: _config2.default.client_id
}, {
    redirect_uri: _config2.default.redirect_uri
});

console.log("Hello js", _hellojs2.default);
...
var githubAuthLink = document.querySelector('#GitHub-login');
githubAuthLink.addEventListener('click', function () {
...
_hellojs2.default.on('auth.login', function (auth) {
    ...
    (0, _hellojs2.default)(auth.network).api('me').then(function (r) {
...
function addTopic(event) {
    event.preventDefault();
    var topicTitle = document.querySelector;
    if (topicTitle) {
        var addedTopicData = {
            topicId: Date.now(),
